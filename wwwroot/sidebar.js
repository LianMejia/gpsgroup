...
export async function renderTree({
  ...
  console.log('llego docId', docId)
  console.log('llego additionalFilter', additionalFilter)
  ...
  await Promise.all(
    items.map(async (item) => {
      ...
      // Verificar si el item coincide con el DOC-ID y el filtro adicional
      const matchesDocId = item.text.includes(docId);
      const matchesAdditionalFilter = item.text.includes(additionalFilter)
